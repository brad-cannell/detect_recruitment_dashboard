...
```{r}
# Variables to help calculate calls made last week, calls made two weeks ago, 
...
```{r}
# Calculate summary statistics about followups made that will be used in the charts below
followups <- gift_card %>%
...
```{r}
# Variables to help calculate followups made last week, followups made two weeks ago, 
# and the percent change.
# Identify last week (i.e., the Monday of the most recent complete Monday-Sunday)
# Identify two weeks ago (i.e., the Monday before that)
followups <- followups %>% 
...
Call Timing {data-orientation=columns}
=======================================================================
